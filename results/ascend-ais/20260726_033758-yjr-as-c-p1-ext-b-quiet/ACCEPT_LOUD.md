# Acceptance (loud): P1-EXT-B

- window: measure step [100, 300] rank0 `step_ms` median
- dose: `loud`
- threshold C1/C0 ≥ **1.15** (cli:--min-ratio=1.15)
- recipes: `/tmp/yjr_fs_orch_20260726_033758/huawei_root/scripts/fail-slow/dose_recipes.yaml`
...
| C1_inject_none | 88.17 | 1.16 |
| C2_probing | 89.63 | 1.18 |
