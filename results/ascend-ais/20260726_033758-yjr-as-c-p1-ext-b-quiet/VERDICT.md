# Verdict — 20260726_033758-yjr-as-c-p1-ext-b-quiet (quiet)
...
|---|---:|---:|---|---|---|
| P1-EXT-B | 1.16 | D3 | rank_7 | rank_7 | d1_thr=1.15 (recipes:project/probing-huawei/scripts/fail-slow/dose_recipes.yaml: |
...
- CSV: `project/probing-huawei/results/ascend-ais/20260726_033758-yjr-as-c-p1-ext-b-quiet/scoring_table_quiet.csv`
