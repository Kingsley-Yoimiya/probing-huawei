# Verdict — 20260726_102936-yjr-as-c-p3-ext-c-quiet (quiet)
...
|---|---:|---:|---|---|---|
| P3-EXT-C | 1.91 | D3 | rank_11 | rank_7 | d1_thr=1.15 (recipes:project/probing-huawei/scripts/fail-slow/dose_recipes.yaml: |
...
- CSV: `project/probing-huawei/results/ascend-ais/20260726_102936-yjr-as-c-p3-ext-c-quiet/scoring_table_quiet.csv`
