...
OUT='/data/yinjinrun.p-huawei/results/ascend-ais/20260726_025116-yjr-as-c-p1-sw-c-masked/P1-SW-C/by_pod/grj-megatron-32card-0716-master-0/round_1/C0_baseline'
...
/root/miniconda3/envs/llm_test/bin/torchrun --nnodes=1 --nproc_per_node=16 --node_rank=0 \
  ...
  --run-id=20260726_025116-yjr-as-c-p1-sw-c-masked --group=0 --config='C0_baseline' --round=1 \
