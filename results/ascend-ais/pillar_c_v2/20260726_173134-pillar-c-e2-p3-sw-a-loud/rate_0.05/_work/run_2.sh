...
export PROBING=1; export PROBING_GPU=on; export PROBING_GPU_BACKEND=npu; export PROBING_NPU_SOURCE=auto; export PROBING_GPU_SAMPLE_MS=500; export PROBING_CPU=on; export PROBING_CPU_SAMPLE_MS=500; export PYTHONPATH=/afs-a3-241ceshi-shared/yinjinrun.p-huawei/probe-bundle/pydeps:${PYTHONPATH:-}; export PATH=/afs-a3-241ceshi-shared/yinjinrun.p-huawei/probe-bundle/pydeps/bin:/root/miniconda3/envs/llm_test/bin:${PATH}; export PROBING_TORCH_PROFILING='on,rate=0.05'; unset PROBING_COLD_MAX_TOTAL_MB 2>/dev/null || true; export PROBING_DATA_DIR='/afs-a3-weight-share/yinjinrun.p-huawei/results/ascend-ais/pillar_c_v2/20260726_173134-pillar-c-e2-p3-sw-a-loud/rate_0.05/probing_data'; unset PROBING_COLD 2>/dev/null || true; export INLINE_INJECT=8a; export INLINE_VICTIM_LOCAL_RANK=7; export INLINE_INJECT_START=100; export INLINE_INJECT_STOP=300; export INLINE_GC_EVERY=1; export INLINE_GC_STALL_S=0.25;
OUT='/afs-a3-weight-share/yinjinrun.p-huawei/results/ascend-ais/pillar_c_v2/20260726_173134-pillar-c-e2-p3-sw-a-loud/rate_0.05/P3-SW-A/by_pod/grj-megatron-32card-0716-worker-0/round_1/C2_probing'
...
/root/miniconda3/envs/llm_test/bin/torchrun --nnodes=1 --nproc_per_node=16 --node_rank=0 \
  ...
  --run-id=20260726_173134-pillar-c-e2-p3-sw-a-loud-rate_0.05 --group=2 --config='C2_probing' --round=1 \
