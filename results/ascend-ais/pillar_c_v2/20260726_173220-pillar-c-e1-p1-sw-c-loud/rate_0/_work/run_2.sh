...
/root/miniconda3/envs/llm_test/bin/torchrun --nnodes=1 --nproc_per_node=16 --node_rank=0 \
  ...
  --run-id=20260726_173220-pillar-c-e1-p1-sw-c-loud-rate_0 --group=2 --config='C2_probing' --round=1 \
