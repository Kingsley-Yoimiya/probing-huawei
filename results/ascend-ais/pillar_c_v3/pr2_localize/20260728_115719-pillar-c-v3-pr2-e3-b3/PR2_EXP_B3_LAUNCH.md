...
| arm | `20260728_115719-pillar-c-v3-pr2-e3-b3-upgrade_rate_1.0` |
| pod | `yysong-worker-0` |
| case | P3-SW-A · GT culprit rank=7 |
| scope | localize + B3 时基 `45`s（steps=`0`） |
...
- SET_DOWNGRADE @ **时间** window_s=45s（或可选步数）→ rate=0（同 pid）
- jexec_poll 超时=25s；hang_max=900s

## 发射
`_prep/launch_exp_b3.sh` @ 2026-07-28T11:57:19+08:00
