# Verdict — 20260726_000113-yjr-as-c-p3-sw-b-masked (masked)
...
|---|---:|---:|---|---|---|
| P3-SW-B | 1.91 | D3 | rank_7 | rank_7 | d1_thr=1.05 (recipes:project/probing-huawei/scripts/fail-slow/dose_recipes.yaml: |
...
- CSV: `project/probing-huawei/results/ascend-ais/20260726_000113-yjr-as-c-p3-sw-b-masked/scoring_table_masked.csv`
