# Verdict — 20260726_005203-yjr-as-c-p1-hw-b-quiet (quiet)
...
|---|---:|---:|---|---|---|
| P1-HW-B | 1.22 | D3 | rank_7 | rank_7 | d1_thr=1.15 (recipes:project/probing-huawei/scripts/fail-slow/dose_recipes.yaml: |
...
- CSV: `project/probing-huawei/results/ascend-ais/20260726_005203-yjr-as-c-p1-hw-b-quiet/scoring_table_quiet.csv`
