# Greyhound Contrast · P1-EXT-B quiet

- run_id: `contrast-p1-ext-b-quiet-20260726_035533`
- case_ref: `20260726_033758-yjr-as-c-p1-ext-b-quiet`
- dose_label: `quiet`；dose: INLINE hbm mb=256 copies=16 victim=7; window [100,300]; gold≈1.161；窗对齐 Case [100,300]
- fairness: `collect_seq` 真实 per-rank 序列 + C0 假阳性对照
- detect_ok: **yes**；detect_mode: **autonomous**（自主= coll 比≥1.15 或 Rbeast 变点[C1有/C0无]）
- oracle_trigger: **no**（未把注入窗写入判定）；注入窗 [100,300] 仅标注；step_ms 窗比=1.170（剂量核对，非 Greyhound 规则）
...
|-----|---------:|--------:|---------:|-----------:|---------------:|
| C0  | 369108 | 4401 | 10 | 8 | 0 |
| C1  | 373367 | 4401 | 10 | 8 | 2 |

- C1 changepoints: [{'id': 149, 't': 18.86412501335144}, {'id': 345, 't': 38.4646680355072}]
- C0 changepoints: []
