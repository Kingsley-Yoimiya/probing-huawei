# Greyhound Contrast · P3-SW-B quiet

- run_id: `contrast-p3-sw-b-quiet-20260725_235209`
- case_ref: `20260725_232814-yjr-as-c-p3-sw-b-quiet`
- dose_label: `quiet`；dose: INLINE 8b mb=8 stall_s=0.1 victim=7; window [100,300]; gold≈2.101；窗对齐 Case [100,300]
...
**C1/C0 coll ratio = 0.943** → FAIL (thr 1.15)
...
|-----|---------:|--------:|---------:|-----------:|---------------:|
| C0  | 214195 | 4401 | 10 | 8 | 0 |
| C1  | 218739 | 4401 | 10 | 8 | 0 |
