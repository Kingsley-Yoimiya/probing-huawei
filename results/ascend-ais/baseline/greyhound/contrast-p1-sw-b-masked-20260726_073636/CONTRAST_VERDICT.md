# Greyhound Contrast · P1-SW-B masked

- run_id: `contrast-p1-sw-b-masked-20260726_073636`
- case_ref: `20260726_072137-yjr-as-c-p1-sw-b-masked`
- dose_label: `masked`；dose: INLINE 2b rare_seq=1408 every=1 victim=7; window [100,300]; gold≈1.287；窗对齐 Case [100,300]
- fairness: `collect_seq` 真实 per-rank 序列 + C0 假阳性对照
- detect_ok: **yes**；detect_mode: **autonomous**（自主= coll 比≥1.05 或 Rbeast 变点[C1有/C0无]）
- oracle_trigger: **no**（未把注入窗写入判定）；注入窗 [100,300] 仅标注；step_ms 窗比=1.299（剂量核对，非 Greyhound 规则）
...
|-----|---------:|--------:|---------:|-----------:|---------------:|
| C0  | 471996 | 4401 | 10 | 8 | 0 |
| C1  | 476501 | 4401 | 10 | 8 | 2 |

- C1 changepoints: [{'id': 150, 't': 18.19909381866455}, {'id': 346, 't': 39.4017767906189}]
- C0 changepoints: []
