# Greyhound Contrast · P1-SW-A quiet

- run_id: `contrast-p1-sw-a-quiet-20260726_044118`
- case_ref: `20260726_042922-yjr-as-c-p1-sw-a-quiet`
- dose_label: `quiet`；dose: INLINE 2a chunks=3 stall_mb=128 stall_s=0.05 victim=7; window [100,300]; gold≈1.638；窗对齐 Case [100,300]
- fairness: `collect_seq` 真实 per-rank 序列 + C0 假阳性对照
- detect_ok: **yes**；detect_mode: **autonomous**（自主= coll 比≥1.15 或 Rbeast 变点[C1有/C0无]）
- oracle_trigger: **no**（未把注入窗写入判定）；注入窗 [100,300] 仅标注；step_ms 窗比=1.647（剂量核对，非 Greyhound 规则）
...
**C1/C0 coll ratio = 1.028** → FAIL (thr 1.15)
...
|-----|---------:|--------:|---------:|-----------:|---------------:|
| C0  | 408003 | 4401 | 10 | 8 | 0 |
| C1  | 412509 | 4401 | 10 | 8 | 2 |

- C1 changepoints: [{'id': 215, 't': 23.75777792930603}, {'id': 348, 't': 41.085111141204834}]
- C0 changepoints: []
