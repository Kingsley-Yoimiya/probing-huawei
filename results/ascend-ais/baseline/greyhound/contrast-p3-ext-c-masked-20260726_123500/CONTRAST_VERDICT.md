# Greyhound Contrast · P3-EXT-C masked

- run_id: `contrast-p3-ext-c-masked-20260726_123500`
- case_ref: `20260726_122130-yjr-as-c-p3-ext-c-masked`
- dose_label: `masked`；dose: stress_vm vm_n=32,vm_bytes=4G; window [100,300]; gold≈1.744；窗对齐 Case [100,300]
- fairness: `collect_seq` 真实 per-rank 序列 + C0 假阳性对照
- detect_ok: **no**；detect_mode: **no_bite**（自主= coll 比≥1.05 或 Rbeast 变点[C1有/C0无]）
- oracle_trigger: **no**（未把注入窗写入判定）；注入窗 [100,300] 仅标注；step_ms 窗比=1.542（剂量核对，非 Greyhound 规则）
...
**C1/C0 coll ratio = 1.029** → FAIL (thr 1.05)
...
|-----|---------:|--------:|---------:|-----------:|---------------:|
| C0  | 559070 | 4401 | 10 | 8 | 0 |
| C1  | 563375 | 4401 | 10 | 8 | 0 |
