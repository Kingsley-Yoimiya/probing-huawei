# Greyhound Contrast · P1-HW-B quiet

- run_id: `contrast-p1-hw-b-quiet-20260726_010435`
- case_ref: `20260726_005203-yjr-as-c-p1-hw-b-quiet`
- dose_label: `quiet`；dose: INLINE hbm ramp mb=320 copies=5→30 victim=7; window [100,300]; gold≈1.219；窗对齐 Case [100,300]
- fairness: `collect_seq` 真实 per-rank 序列 + C0 假阳性对照
- detect_ok: **yes**；detect_mode: **autonomous**（自主= coll 比≥1.15 或 Rbeast 变点[C1有/C0无]）
- oracle_trigger: **no**（未把注入窗写入判定）；注入窗 [100,300] 仅标注；step_ms 窗比=1.213（剂量核对，非 Greyhound 规则）
...
**C1/C0 coll ratio = 0.972** → FAIL (thr 1.15)
...
|-----|---------:|--------:|---------:|-----------:|---------------:|
| C0  | 254007 | 4401 | 10 | 8 | 0 |
| C1  | 258412 | 4401 | 10 | 8 | 2 |

- C1 changepoints: [{'id': 150, 't': 18.234970092773438}, {'id': 348, 't': 38.149308919906616}]
- C0 changepoints: []
