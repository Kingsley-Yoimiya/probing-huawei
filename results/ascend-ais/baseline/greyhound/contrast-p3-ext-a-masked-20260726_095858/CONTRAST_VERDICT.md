# Greyhound Contrast · P3-EXT-A masked

- run_id: `contrast-p3-ext-a-masked-20260726_095858`
- case_ref: `20260726_094648-yjr-as-c-p3-ext-a-masked`
- dose_label: `masked`；dose: stress_cpu cpu_n=128 cpu_load=70 victim=7; window [100,300]; gold≈1.470；窗对齐 Case [100,300]
- fairness: `collect_seq` 真实 per-rank 序列 + C0 假阳性对照
- detect_ok: **no**；detect_mode: **no_bite**（自主= coll 比≥1.05 或 Rbeast 变点[C1有/C0无]）
- oracle_trigger: **no**（未把注入窗写入判定）；注入窗 [100,300] 仅标注；step_ms 窗比=0.789（剂量核对，非 Greyhound 规则）
...
|-----|---------:|--------:|---------:|-----------:|---------------:|
| C0  | 515234 | 4401 | 10 | 8 | 0 |
| C1  | 520018 | 4401 | 10 | 8 | 0 |
