# Verdict — 20260726_122130-yjr-as-c-p3-ext-c-masked (masked)
...
|---|---:|---:|---|---|---|
| P3-EXT-C | 1.74 | D3 | rank_12 | rank_7 | d1_thr=1.05 (recipes:project/probing-huawei/scripts/fail-slow/dose_recipes.yaml: |
...
- CSV: `project/probing-huawei/results/ascend-ais/20260726_122130-yjr-as-c-p3-ext-c-masked/scoring_table_masked.csv`
