# Verdict — 20260726_011501-yjr-as-c-p1-hw-b-masked (masked)
...
|---|---:|---:|---|---|---|
| P1-HW-B | 1.13 | D3 | rank_7 | rank_7 | d1_thr=1.05 (recipes:project/probing-huawei/scripts/fail-slow/dose_recipes.yaml: |
...
- CSV: `project/probing-huawei/results/ascend-ais/20260726_011501-yjr-as-c-p1-hw-b-masked/scoring_table_masked.csv`
