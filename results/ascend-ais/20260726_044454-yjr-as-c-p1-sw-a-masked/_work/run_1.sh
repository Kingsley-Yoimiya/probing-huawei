...
unset PROBING PROBING_TORCH_PROFILING PROBING_GPU INLINE_INJECT 2>/dev/null || true; export PROBING=0; export INLINE_INJECT=2a; export INLINE_VICTIM_LOCAL_RANK=7; export INLINE_INJECT_START=100; export INLINE_INJECT_STOP=300; export INLINE_2A_CHUNKS=1; export INLINE_2A_STALL_MB=64; export INLINE_2A_STALL_S=0.02;
OUT='/data/yinjinrun.p-huawei/results/ascend-ais/20260726_044454-yjr-as-c-p1-sw-a-masked/P1-SW-A/by_pod/grj-megatron-32card-0716-master-0/round_1/C1_inject_none'
...
/root/miniconda3/envs/llm_test/bin/torchrun --nnodes=1 --nproc_per_node=16 --node_rank=0 \
  ...
  --run-id=20260726_044454-yjr-as-c-p1-sw-a-masked --group=1 --config='C1_inject_none' --round=1 \
