# Verdict — 20260726_125953-yjr-as-c-p3-sw-c-quiet (quiet)
...
|---|---:|---:|---|---|---|
| P3-SW-C | 1.95 | D3 | rank_7 | rank_7 | d1_thr=1.15 (recipes:project/probing-huawei/scripts/fail-slow/dose_recipes.yaml: |
...
- CSV: `project/probing-huawei/results/ascend-ais/20260726_125953-yjr-as-c-p3-sw-c-quiet/scoring_table_quiet.csv`
