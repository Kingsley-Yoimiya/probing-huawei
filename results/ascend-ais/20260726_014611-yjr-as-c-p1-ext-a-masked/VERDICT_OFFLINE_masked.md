# Verdict — 20260726_014611-yjr-as-c-p1-ext-a-masked (masked)
...
|---|---:|---:|---|---|---|
| P1-EXT-A | 1.08 | D3 | rank_8 | rank_7 | d1_thr=1.05 (recipes:project/probing-huawei/scripts/fail-slow/dose_recipes.yaml: |
...
- CSV: `project/probing-huawei/results/ascend-ais/20260726_014611-yjr-as-c-p1-ext-a-masked/scoring_table_masked.csv`
