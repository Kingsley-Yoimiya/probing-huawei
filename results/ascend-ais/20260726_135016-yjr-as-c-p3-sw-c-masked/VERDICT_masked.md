# Verdict — 20260726_135016-yjr-as-c-p3-sw-c-masked (masked)
...
|---|---:|---:|---|---|---|
| P3-SW-C | 1.65 | D3 | rank_0 | rank_7 | d1_thr=1.05 (recipes:project/probing-huawei/scripts/fail-slow/dose_recipes.yaml: |
...
- CSV: `project/probing-huawei/results/ascend-ais/20260726_135016-yjr-as-c-p3-sw-c-masked/scoring_table_masked.csv`
