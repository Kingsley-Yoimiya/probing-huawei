...
OUT='/afs-a3-weight-share/yinjinrun.p-huawei/results/ascend-ais/20260726_094648-yjr-as-c-p3-ext-a-masked/P3-EXT-A/by_pod/grj-megatron-32card-0716-master-0/round_1/C1_inject_none'
...
/root/miniconda3/envs/llm_test/bin/torchrun --nnodes=1 --nproc_per_node=16 --node_rank=0 \
  ...
  --run-id=20260726_094648-yjr-as-c-p3-ext-a-masked --group=1 --config='C1_inject_none' --round=1 \
