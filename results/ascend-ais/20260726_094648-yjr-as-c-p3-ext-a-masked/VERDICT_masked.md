# Verdict — 20260726_094648-yjr-as-c-p3-ext-a-masked (masked)
...
|---|---:|---:|---|---|---|
| P3-EXT-A | 1.47 | D3 | rank_4 | rank_7 | d1_thr=1.05 (recipes:project/probing-huawei/scripts/fail-slow/dose_recipes.yaml: |
...
- CSV: `project/probing-huawei/results/ascend-ais/20260726_094648-yjr-as-c-p3-ext-a-masked/scoring_table_masked.csv`
