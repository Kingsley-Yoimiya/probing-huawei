# Verdict — 20260726_021606-yjr-as-c-p1-sw-c-quiet (quiet)
...
|---|---:|---:|---|---|---|
| P1-SW-C | 2.61 | D3 | rank_7 | rank_7 | d1_thr=1.15 (recipes:project/probing-huawei/scripts/fail-slow/dose_recipes.yaml: |
...
- CSV: `project/probing-huawei/results/ascend-ais/20260726_021606-yjr-as-c-p1-sw-c-quiet/scoring_table_quiet.csv`
