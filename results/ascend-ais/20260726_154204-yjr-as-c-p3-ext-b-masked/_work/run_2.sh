...
export CKPT_DIR=/afs-a3-weight-share/yinjinrun.p-huawei/probe-bundle/io_stress/ckpt
...
OUT='/afs-a3-weight-share/yinjinrun.p-huawei/results/ascend-ais/20260726_154204-yjr-as-c-p3-ext-b-masked/P3-EXT-B/by_pod/grj-megatron-32card-0716-master-0/round_1/C2_probing'
...
/root/miniconda3/envs/llm_test/bin/torchrun --nnodes=1 --nproc_per_node=16 --node_rank=0 \
  ...
  --flush-every=1 --ckpt-every=50 \
  --io-payload='/afs-a3-weight-share/yinjinrun.p-huawei/probe-bundle/io_stress/payload.bin' --io-read-kb=256 \
  --run-id=20260726_154204-yjr-as-c-p3-ext-b-masked --group=2 --config='C2_probing' --round=1 \
